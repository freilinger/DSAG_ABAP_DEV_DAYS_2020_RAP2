CLASS zrap_call_bo_generator_sfh DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zrap_call_bo_generator_sfh IMPLEMENTATION.
...
*        ).
        ...
        DATA(rap_bo_generator) = NEW zrap_cl_bo_generator(
          iv_package            =  'ZRAP_INVENTORY_M_SFH'
          iv_namespace = 'ZRAP_'
          iv_header_table       = 'ZRAP_INVEN_SFH'
